 ...
 * including initializing players, handling multiple games, and tracking game statistics.
 */
public class GameManager {
     ...
     *
     * @param output         An ArrayNode to store the output of each action in a game.
     * @param objectNode     An ArrayNode object used in the game processing.
     ...
     * <ol>
     *     <li>Picks the chosen deck based on the index provided in the game input.</li>
     *     <li>Transforms the chosen deck into a list of {@link MinionCard} objects.</li>
     *     <li>Shuffles the deck using a random seed specified in the game input.</li>
     *     <li>Assigns a hero card to the player based on the game input.</li>
     * </ol>
     *
     * @param inputData an instance of {@link Input} containing available deck data
     * @param startGame an instance of {@link StartGameInput} containing game-specific
